...
<form action="${pageContext.request.contextPath}/personen" method="post">
...
<form action="${pageContext.request.contextPath}/objekte" method="post">
...
<h3><a href="${pageContext.request.contextPath}/objekte">Liste aller Objekte anzeigen</a></h3>

<h2>Reservierungen verwalten</h2>
<!-- Formular zur Erfassung einer neuen Reservierung -->
<form action="${pageContext.request.contextPath}/reservierungen" method="post">
    ...
    <label for="startDatum">Startdatum (YYYY-MM-DDTHH:MM):</label><br>
    <input type="datetime-local" id="startDatum" name="startDatum" required><br>
    
    <label for="endDatum">Enddatum (YYYY-MM-DDTHH:MM):</label><br>
...
<h3><a href="${pageContext.request.contextPath}/reservierungen">Liste aller Reservierungen anzeigen</a></h3>
